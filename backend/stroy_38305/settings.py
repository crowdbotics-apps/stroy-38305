"""
Django settings for stroy_38305 project.
...
WSGI_APPLICATION = 'stroy_38305.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "stroy_38305 API",
    "DESCRIPTION": "API documentation for stroy_38305 App",
    "VERSION": "v1",
}
